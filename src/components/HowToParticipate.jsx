...
export default function HowToParticipate() {
  return (
    <div className="bg-[#f4f4fa] flex flex-col gap-[21px] items-center px-[20px] py-[34px] pb-[100px] relative w-full" data-name="How to participate" data-node-id="206:15630">
      ...
      <div className="bg-white flex flex-col h-[394px] items-start justify-between p-[24px] relative rounded-[20px] shrink-0 w-[320px]" data-name="explanation" data-node-id="206:15632">
        <div className="flex items-center justify-between relative shrink-0 w-[262px]" data-name="STEP 1" data-node-id="206:15633">
          ...
          <div className="flex flex-col gap-[12px] items-start not-italic relative shrink-0 w-[148px]" data-name="text" data-node-id="206:15637">
            <div className="flex flex-col gap-[4px] items-start relative shrink-0 w-[114px]" data-name="title" data-node-id="206:15638">
            ...
            <div className="flex flex-col font-['Pretendard',sans-serif] justify-center min-w-full relative shrink-0 text-[#6e6e6e] text-[12px] text-center tracking-[-0.3px] w-[min-content]" data-node-id="206:15641">
              <p className="leading-[1.26]">원하는 상품 확인 후 구매하세요!</p>
            </div>
          </div>
        </div>
        <div className="flex gap-[24px] items-center relative shrink-0" data-name="STEP 2" data-node-id="206:15642">
          ...
          <div className="flex flex-col gap-[12px] items-start not-italic relative shrink-0 w-[125px]" data-name="text" data-node-id="206:15646">
            <div className="flex flex-col gap-[4px] items-start relative shrink-0 w-[99px]" data-name="title" data-node-id="206:15647">
            ...
            <div className="flex flex-col font-['Pretendard',sans-serif] justify-center min-w-full relative shrink-0 text-[#6e6e6e] text-[12px] text-center tracking-[-0.3px] w-[min-content]" data-node-id="206:15650">
              <p className="leading-[1.26]">인증 미션 수행 후 제출해요!</p>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-between relative shrink-0 w-[260.008px]" data-name="STEP 3" data-node-id="206:15651">
          ...
          <div className="flex flex-col gap-[12px] items-start not-italic relative shrink-0 w-[146px]" data-name="text" data-node-id="206:15655">
            <div className="flex flex-col gap-[4px] items-start relative shrink-0 w-[81px]" data-name="title" data-node-id="206:15656">
            ...
            <div className="flex flex-col font-['Pretendard',sans-serif] justify-center leading-[1.26] min-w-full relative shrink-0 text-[#6e6e6e] text-[12px] tracking-[-0.3px] w-[min-content]" data-node-id="206:15659">
      ...
      <div className="absolute flex h-[22px] items-center justify-center left-[89px] top-[207px] w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "41" }}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[22px]" data-name="Line_1" data-node-id="206:15660">
      ...
      <div className="absolute flex h-[22px] items-center justify-center left-[89px] top-[334px] w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "41" }}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[22px]" data-name="Line_2" data-node-id="206:15661">
            <div className="absolute inset-[-2px_0_0_0]">
              <img alt="" className="block max-w-none size-full" src={imgLine1} />
            </div>
          </div>
